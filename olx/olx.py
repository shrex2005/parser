...
async def olx():
    ...
    for p in range(fp, lp + 1):
        ...
        if p == fp:
            url = 'https://www.olx.ua/d/uk/transport/legkovye-avtomobili/audi/?currency=UAH'
        else:
            url = f"https://www.olx.ua/d/uk/transport/legkovye-avtomobili/audi/?currency=UAH&page=2" 
